...
@Component({
  selector: 'app-sidebarra-mobile-cliente',
  templateUrl: './sidebarra-mobile-cliente.component.html',
  styleUrls: ['./sidebarra-mobile-cliente.component.scss']
})
export class SidebarraMobileClienteComponent {
  isOpen = false;
  isMobile = false;
