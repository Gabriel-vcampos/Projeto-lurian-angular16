...
public class AgendamentoController {
    ...
    @Transactional
    public ResponseEntity<Map<String, String>> cadastrarAgendamento(@RequestBody @Valid DadosCadastroAgendamento dados) {
        agendamentoService.criarAgendamento(dados);
        
        Map<String, String> response = new HashMap<>();
        response.put("mensagem", "Agendamento cadastrado com sucesso!");
